...
namespace SeniorMoment.Views
{
    public sealed partial class TimerStrip : UserControl, IEquatable<TimerStrip>
    {
        ...
        public TimerStrip HotTimerStrip;
        ...
        internal void Initialise()
        {
            ...
            TimerControlButtons.ForEach(timerCB => timerCB.Initialise(this));
        }
        ...
        public void NotifySegments()
        {
            Statics.RunOnUI(new Action(() =>
            {
                TimerSegments.ForEach(button => button.NotifyPropertyChanged("ButtonContent"));
                TimerSegments.ForEach(button => button.NotifyPropertyChanged("Brush"));
            }));
        }
        ...
        public void TickAt(int secondsToZero)
        {
            ...
            TickOnUI();
            Statics.RunOnUI(new Action(Tickxxx));
        }
        #endregion Tick
