...
namespace SeniorMoment.Views
{
    public sealed partial class VMicrophone : UserControl, INotifyPropertyChanged
    {
        ...
        #region    MicrophoneBackgroundBrush
        /// <summary>
        ...
        /// </summary>
        SolidColorBrush MicrophoneBackgroundBrush
        {
            get
            {
                switch (MicrophoneStatus)
        ...
        SolidColorBrush BrushReadyToRecord = new SolidColorBrush(Colors.LightGreen);
        SolidColorBrush BrushPressed = new SolidColorBrush(Colors.Green);
        SolidColorBrush BrushRecording = new SolidColorBrush(Colors.Red);
        SolidColorBrush BrushDisabled = new SolidColorBrush(Colors.LightGray);
        #endregion MicrophoneBackgroundBrush
        ...
        ///// <summary>
        ///// Set true when user 'mouses' over the microphone, and false when it leaving
        ///// </summary>
        //public bool pointerEntered { get; private set; } = false;
        //#endregion pointerEntered
